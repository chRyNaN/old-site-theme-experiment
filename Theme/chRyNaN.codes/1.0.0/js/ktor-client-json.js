(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-http', 'ktor-client-core', 'kotlinx-coroutines-io', 'ktor-utils'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-http'), require('ktor-client-core'), require('kotlinx-coroutines-io'), require('ktor-utils'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-client-json'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-client-json'.");
    }
    if (typeof this['ktor-http'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-json'. Its dependency 'ktor-http' was not found. Please, check whether 'ktor-http' is loaded prior to 'ktor-client-json'.");
    }
    if (typeof this['ktor-client-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-json'. Its dependency 'ktor-client-core' was not found. Please, check whether 'ktor-client-core' is loaded prior to 'ktor-client-json'.");
    }
    if (typeof this['kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-json'. Its dependency 'kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-coroutines-io' is loaded prior to 'ktor-client-json'.");
    }
    if (typeof this['ktor-utils'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-json'. Its dependency 'ktor-utils' was not found. Please, check whether 'ktor-utils' is loaded prior to 'ktor-client-json'.");
    }
    root['ktor-client-json'] = factory(typeof this['ktor-client-json'] === 'undefined' ? {} : this['ktor-client-json'], kotlin, this['ktor-http'], this['ktor-client-core'], this['kotlinx-coroutines-io'], this['ktor-utils']);
  }
}(this, function(_, Kotlin, $module$ktor_http, $module$ktor_client_core, $module$kotlinx_coroutines_io, $module$ktor_utils) {
  'use strict';
  ...
  Kotlin.defineModule('ktor-client-json', _);
  return _;
}));

(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-http', 'kotlinx-io', 'kotlinx-coroutines-io', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-http'), require('kotlinx-io'), require('kotlinx-coroutines-io'), require('kotlinx-coroutines-core'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-http-cio'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-http-cio'.");
    }
    if (typeof this['ktor-http'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-cio'. Its dependency 'ktor-http' was not found. Please, check whether 'ktor-http' is loaded prior to 'ktor-http-cio'.");
    }
    if (typeof this['kotlinx-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-cio'. Its dependency 'kotlinx-io' was not found. Please, check whether 'kotlinx-io' is loaded prior to 'ktor-http-cio'.");
    }
    if (typeof this['kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-cio'. Its dependency 'kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-coroutines-io' is loaded prior to 'ktor-http-cio'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-cio'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-http-cio'.");
    }
    root['ktor-http-cio'] = factory(typeof this['ktor-http-cio'] === 'undefined' ? {} : this['ktor-http-cio'], kotlin, this['ktor-http'], this['kotlinx-io'], this['kotlinx-coroutines-io'], this['kotlinx-coroutines-core']);
  }
}(this, function(_, Kotlin, $module$ktor_http, $module$kotlinx_io, $module$kotlinx_coroutines_io, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var xor = defineInlineFunction('ktor-http-cio.io.ktor.http.cio.websocket.xor_34yeqm$', wrapFunction(function() {
  var toByte = Kotlin.toByte;
  return function($receiver, other) {
  return toByte($receiver ^ other);
};
}));
  var flagAt = defineInlineFunction('ktor-http-cio.io.ktor.http.cio.websocket.flagAt_wndlt3$', function($receiver, at) {
  ...
  $$importsForInline$$['ktor-http-cio'] = _;
  ...
  Kotlin.defineModule('ktor-http-cio', _);
  return _;
}));

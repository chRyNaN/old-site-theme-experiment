(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-utils', 'kotlinx-io', 'kotlinx-coroutines-core', 'kotlinx-coroutines-io', 'ktor-http', 'ktor-http-cio'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-utils'), require('kotlinx-io'), require('kotlinx-coroutines-core'), require('kotlinx-coroutines-io'), require('ktor-http'), require('ktor-http-cio'));
  else {
    ...
    if (typeof this['ktor-http-cio'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-core'. Its dependency 'ktor-http-cio' was not found. Please, check whether 'ktor-http-cio' is loaded prior to 'ktor-client-core'.");
    }
    root['ktor-client-core'] = factory(typeof this['ktor-client-core'] === 'undefined' ? {} : this['ktor-client-core'], kotlin, this['ktor-utils'], this['kotlinx-io'], this['kotlinx-coroutines-core'], this['kotlinx-coroutines-io'], this['ktor-http'], this['ktor-http-cio']);
  }
}(this, function(_, Kotlin, $module$ktor_utils, $module$kotlinx_io, $module$kotlinx_coroutines_core, $module$kotlinx_coroutines_io, $module$ktor_http, $module$ktor_http_cio) {
  'use strict';
  ...
  var charset = $module$ktor_http.io.ktor.http.charset_10ldo9$;
  ...
  var charset_0 = $module$ktor_http.io.ktor.http.charset_v1wgmc$;
  ...
  var HeaderValue = $module$ktor_http.io.ktor.http.HeaderValue;
  ...
  var isSuccess = $module$ktor_http.io.ktor.http.isSuccess_b3he4c$;
  var cacheControl = $module$ktor_http.io.ktor.http.cacheControl_v1wgmc$;
  var Url = $module$ktor_http.io.ktor.http.Url_pboq08$;
  var plus = Kotlin.kotlin.collections.plus_khz7k3$;
  var emptyList = Kotlin.kotlin.collections.emptyList_287e2$;
  var hashCode = Kotlin.hashCode;
  var vary = $module$ktor_http.io.ktor.http.vary_v1wgmc$;
  var emptyMap = Kotlin.kotlin.collections.emptyMap_q3lmfv$;
  var startsWith = Kotlin.kotlin.text.startsWith_7epoxm$;
  var split = Kotlin.kotlin.text.split_ip8yn$;
  var toInt = Kotlin.kotlin.text.toInt_pdl1vz$;
  var L1000 = Kotlin.Long.fromInt(1000);
  var plus_0 = $module$ktor_utils.io.ktor.util.date.plus_e4j7mw$;
  var fromHttpToGmtDate = $module$ktor_http.io.ktor.http.fromHttpToGmtDate_pdl1vz$;
  var GMTDate = $module$ktor_utils.io.ktor.util.date.GMTDate_mts6q2$;
  var parseHeaderValue = $module$ktor_http.io.ktor.http.parseHeaderValue_pdl1vj$;
  var HeadersBuilder_init = $module$ktor_http.io.ktor.http.HeadersBuilder;
  var emptySet = Kotlin.kotlin.collections.emptySet_287e2$;
  var ConcurrentSet = $module$ktor_utils.io.ktor.util.collections.ConcurrentSet;
  var ConcurrentMap = $module$ktor_utils.io.ktor.util.collections.ConcurrentMap;
  ...
  var Url_0 = $module$ktor_http.io.ktor.http.Url_61zpoe$;
  ...
  var split_0 = $module$ktor_utils.io.ktor.util.split_eiug82$;
  var launch = $module$kotlinx_coroutines_core.kotlinx.coroutines.launch_s496o7$;
  var WebSocketSession = $module$ktor_http_cio.io.ktor.http.cio.websocket.WebSocketSession;
  var DefaultWebSocketSession = $module$ktor_http_cio.io.ktor.http.cio.websocket.DefaultWebSocketSession;
  var websocketServerAccept = $module$ktor_http.io.ktor.http.websocket.websocketServerAccept_61zpoe$;
  var generateNonce = $module$ktor_utils.io.ktor.util.generateNonce_za3lpa$;
  var encodeBase64 = $module$ktor_utils.io.ktor.util.encodeBase64_964n91$;
  var isWebsocket = $module$ktor_http.io.ktor.http.isWebsocket_v5fpbg$;
  var DefaultWebSocketSession_0 = $module$ktor_http_cio.io.ktor.http.cio.websocket.DefaultWebSocketSession_23cfxb$;
  ...
  var CloseReason$Codes = $module$ktor_http_cio.io.ktor.http.cio.websocket.CloseReason.Codes;
  var CloseReason_init = $module$ktor_http_cio.io.ktor.http.cio.websocket.CloseReason_init_ia8ci6$;
  var CompletableDeferred = $module$kotlinx_coroutines_core.kotlinx.coroutines.CompletableDeferred_xptg6w$;
  var Channel = $module$kotlinx_coroutines_core.kotlinx.coroutines.channels.Channel_ww73n8$;
  var Frame$Binary = $module$ktor_http_cio.io.ktor.http.cio.websocket.Frame.Binary;
  var Frame$Frame$Text_init = $module$ktor_http_cio.io.ktor.http.cio.websocket.Frame.Text_init_61zpoe$;
  var CloseReason = $module$ktor_http_cio.io.ktor.http.cio.websocket.CloseReason;
  var Frame$Frame$Close_init = $module$ktor_http_cio.io.ktor.http.cio.websocket.Frame.Close_init_p695es$;
  ...
  return true;
      ...
      case 3:
        ...
        if (!this.local$info.type.isInstance_s8jyv4$(this.local$result)) {
  ...
  interfaces: []};
  var append = defineInlineFunction('ktor-client-core.io.ktor.client.request.forms.append_vnwi7f$', wrapFunction(function() {

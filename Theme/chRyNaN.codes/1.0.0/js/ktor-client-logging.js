(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-http', 'kotlinx-coroutines-io', 'kotlinx-io', 'kotlinx-coroutines-core', 'ktor-client-core', 'ktor-utils'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-http'), require('kotlinx-coroutines-io'), require('kotlinx-io'), require('kotlinx-coroutines-core'), require('ktor-client-core'), require('ktor-utils'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-client-logging'.");
    }
    if (typeof this['ktor-http'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'ktor-http' was not found. Please, check whether 'ktor-http' is loaded prior to 'ktor-client-logging'.");
    }
    if (typeof this['kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-coroutines-io' is loaded prior to 'ktor-client-logging'.");
    }
    if (typeof this['kotlinx-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'kotlinx-io' was not found. Please, check whether 'kotlinx-io' is loaded prior to 'ktor-client-logging'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-client-logging'.");
    }
    if (typeof this['ktor-client-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'ktor-client-core' was not found. Please, check whether 'ktor-client-core' is loaded prior to 'ktor-client-logging'.");
    }
    if (typeof this['ktor-utils'] === 'undefined') {
      throw new Error("Error loading module 'ktor-client-logging'. Its dependency 'ktor-utils' was not found. Please, check whether 'ktor-utils' is loaded prior to 'ktor-client-logging'.");
    }
    root['ktor-client-logging'] = factory(typeof this['ktor-client-logging'] === 'undefined' ? {} : this['ktor-client-logging'], kotlin, this['ktor-http'], this['kotlinx-coroutines-io'], this['kotlinx-io'], this['kotlinx-coroutines-core'], this['ktor-client-core'], this['ktor-utils']);
  }
}(this, function(_, Kotlin, $module$ktor_http, $module$kotlinx_coroutines_io, $module$kotlinx_io, $module$kotlinx_coroutines_core, $module$ktor_client_core, $module$ktor_utils) {
  'use strict';
  ...
  var contentType = $module$ktor_http.io.ktor.http.contentType_v1wgmc$;
  ...
  var HttpSendPipeline = $module$ktor_client_core.io.ktor.client.request.HttpSendPipeline;
  var Throwable = Error;
  var HttpResponsePipeline = $module$ktor_client_core.io.ktor.client.response.HttpResponsePipeline;
  var ResponseObserver = $module$ktor_client_core.io.ktor.client.features.observer.ResponseObserver;
  ...
  $$importsForInline$$['ktor-client-logging'] = _;
  ...
  Kotlin.defineModule('ktor-client-logging', _);
  return _;
}));

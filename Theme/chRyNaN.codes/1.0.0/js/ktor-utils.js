(function(root, factory) {
  ...
  var intercept = defineInlineFunction('ktor-utils.io.ktor.util.pipeline.intercept_1vle7l$', wrapFunction(function() {
  ...
  return LockTicketInstance;
};
  ReadWriteLock.prototype.writeLock = function() {
  return LockTicketInstance;
};
  ReadWriteLock.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'ReadWriteLock', 
  interfaces: []};
  var LockTicketInstance;
  function LockTicket() {
  }
  LockTicket.prototype.unlock = function() {
};
  LockTicket.$metadata$ = {
  kind: Kind_CLASS, 
  simpleName: 'LockTicket', 
  interfaces: []};
  ...
  package$util.ReadWriteLock = ReadWriteLock;
  package$util.LockTicket = LockTicket;
  ...
  LockTicketInstance = new LockTicket();
